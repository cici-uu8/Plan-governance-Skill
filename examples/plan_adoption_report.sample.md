...
- Found 4 possible plan-related Markdown files.
- 2 look strong enough to auto-register after you review them.
- 0 need human confirmation before entering the registry.
- 2 were weak matches and should usually stay out unless you know they matter.
- 0 Markdown files were skipped before classification because of scan filters, ignore rules, or derived-document rules.
...
- Confidence is only a hint, not a decision.
...
|---|---|---:|---|
| `docs/Week0_准备清单.md` | execution_plan | 0.99 | filename matches execution_plan:*准备清单*; filename matches execution_plan:*清单* |
| `docs/开发主控文档.md` | master_plan | 0.95 | filename matches master_plan:*主控*; filename suggests master plan |
